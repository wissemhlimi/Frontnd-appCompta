...
const SocieteToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    societeSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    societeSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=societe">
