...
import SocieteFormModal from 'src/view/societe/form/SocieteFormModal';
...
const SocieteAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return SocieteService.listAutocomplete(value, limit);
  };
...
export default SocieteAutocompleteFormItem;
