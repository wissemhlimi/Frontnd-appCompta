...
const VenteToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    venteSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    venteSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=vente">
