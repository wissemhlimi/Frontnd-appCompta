...
import VenteFormModal from 'src/view/vente/form/VenteFormModal';
...
const VenteAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return VenteService.listAutocomplete(value, limit);
  };
...
export default VenteAutocompleteFormItem;
