...
const AvoirToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    avoirSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    avoirSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=avoir">
