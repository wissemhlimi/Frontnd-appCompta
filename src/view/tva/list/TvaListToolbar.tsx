...
const TvaToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    tvaSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    tvaSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=tva">
