...
import ActivityFormModal from 'src/view/activity/form/ActivityFormModal';
...
const ActivityAutocompleteFormItem = (props) => {
  ...
  const fetchFn = (value, limit) => {
    return ActivityService.listAutocomplete(value, limit);
  };
...
export default ActivityAutocompleteFormItem;
